        ...
        <div className={styles.page}>
            ...
            <main className={styles.container}>
                ...
                <p>
                    ...
                    d’utilisation du site PizzaTech.
                </p>
                ...
                <p>
                    PizzaTech s’efforce de maintenir le site accessible 24 h/24 mais
                ...
                <p>
                    ...
                    reproduction est interdite sans l’autorisation écrite de PizzaTech.
                </p>
