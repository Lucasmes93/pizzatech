        ...
        <div className={styles.page}>
            ...
            <main className={styles.container}>
                ...
                <section>
                    ...
                    <p>
                        PizzaTech – 31&nbsp;rue Paul&nbsp;Meurice, 75020&nbsp;Paris
                        <br/>
                        SIRET&nbsp;: 123&nbsp;456&nbsp;789&nbsp;00042
                        <br/>
                        Directeur de la publication&nbsp;: Lucas&nbsp;Messia&nbsp;Doliveux
                    </p>
                </section>
                ...
                <section>
                    <h2>Contact</h2>
                    <p>
                        E-mail&nbsp;: <a href="mailto:contact@pizzatech.fr">contact@pizzatech.fr</a>
                        <br/>
                ...
                <section>
                    ...
                    <p>
                        ...
                        PizzaTech sauf mention contraire.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        PizzaTech met tout en œuvre pour fournir des informations exactes,
